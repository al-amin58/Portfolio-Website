                ...
                <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        <div>
                            ...
                            <div class="control">
                                <input class="input" name="project_name" type="text" placeholder="Enter Project Name">
                            </div>
                        </div>
                        <div>
                            <label class="label">Project Category:</label>
                            <div class="control">
                                <input class="input" name="project_category" type="text" placeholder="Enter Project Category">
                            </div>
                        </div>
                        <hr>
